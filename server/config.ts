...
const envSchema = z.object({
  ...
  MAX_CONTEXT_CHARS: z.coerce.number().int().positive().default(120000), MAX_OUTPUT_TOKENS: z.coerce.number().int().positive().default(4096), MAX_FETCH_BYTES: z.coerce.number().int().positive().default(2_000_000), MAX_REDIRECTS: z.coerce.number().int().nonnegative().default(5), MAX_EXTRACTED_CHARS_PER_PAGE: z.coerce.number().int().positive().default(20_000), EXTRACTION_TIMEOUT_MS: z.coerce.number().int().positive().default(8_000),
});
