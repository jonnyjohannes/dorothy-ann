...
/** Transient provider-neutral extraction result; never persisted by itself. */
...
export type ExtractionOutcome =
  ...
  | { sourceId: SourceId; status: "skipped"; reason: "duplicate" | "unsafe_url" | "blocked" | "unsupported_content" | "empty_content" | "limit_reached" }
  | { sourceId: SourceId; status: "failed"; code: "fetch_failed" | "timeout" | "extract_failed"; retryable: boolean };
