...
- Current focus: default-research routing amendment complete
- Handoff lives in: [`## Handoff`](#handoff)
- Next action: none; ordinary input now researches regardless of punctuation, while `/search <query>` explicitly returns ranked links and `/research <question>` explicitly selects the default research path
