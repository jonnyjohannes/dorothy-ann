...
On mobile, opening evidence preserves scroll position in the answer. Closing the sheet returns focus to the citation that opened it. On desktop, citations focus the persistent evidence column.
