...
- Current focus: milestone 4 complete at the storage/export baseline; begin milestone 5 — complete UI workflow states, accessibility behavior, and browser-test coverage
- Handoff lives in: [`## Handoff`](#handoff)
- Next action: complete research/chat/evidence recovery states, citation focus restoration, authenticated deep-link behavior, and add RTL/MSW interaction coverage before Playwright
