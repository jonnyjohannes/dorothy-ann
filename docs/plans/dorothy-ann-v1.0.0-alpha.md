...
- [~] 12. Hardened Vercel alpha — deliverable: configured secure deployment; current: security headers, request bounds, secret scan, provider readiness, and live chat smoke pass locally; remaining: Playwright/axe execution, live research/SSRF smoke, Vercel environment configuration, deployment, and production verification.
