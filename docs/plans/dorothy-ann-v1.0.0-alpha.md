...
- Current focus: staged fixture research orchestration is verified at `/api/research`; continue persistence/retry wiring and extractor hardening before provider-backed orchestration
