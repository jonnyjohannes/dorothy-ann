...
- Current focus: milestone 3 complete at the orchestration baseline; begin milestone 4 — IndexedDB recovery, drafts, backup, and export completion
- Handoff lives in: [`## Handoff`](#handoff)
- Next action: harden `src/adapters/browser/local-stores.ts` and the report workbench with migrations, corrupt-record recovery, autosaved drafts, backup UI, share fallback, and dirty-navigation handling
