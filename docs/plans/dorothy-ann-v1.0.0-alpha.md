...
- Current focus: milestone 2 complete at the implementation baseline; begin milestone 3 — research orchestration and SSE contract hardening
- Handoff lives in: [`## Handoff`](#handoff)
- Next action: harden `server/research.ts` and SSE routes with bounded concurrency, frozen evidence, retries, stop/EOF, heartbeats, sequencing guards, and atomic completion behavior
